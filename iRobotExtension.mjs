...
var Scratch3NewBlocks = /*#__PURE__*/function () {
   ...
   */
  return _createClass(Scratch3NewBlocks, [{
    key: "getInfo",
    ...
    /**
     * Handle notifications from the TX characteristic.
     * @param {Event} event - The event containing the notification data.
     */
    )
  }, {
...
export { Scratch3NewBlocks as blockClass, entry };
